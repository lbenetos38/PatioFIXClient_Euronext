...
namespace PatioFIX.Common.FixSupport
{
    ...
    /// </summary>
    [Serializable]
    public class PtFixFatalProtocolException : PtFixException
    {
        /// <summary>
        ...
        /// </summary>
        public PtFixFatalProtocolException()
            : base("FatalProtocolException")
        {
        }
        ...
        public PtFixFatalProtocolException(string message)
            : base(message)
        {
        }
        ...
        protected PtFixFatalProtocolException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public PtFixFatalProtocolException(string message, Exception innerException)
