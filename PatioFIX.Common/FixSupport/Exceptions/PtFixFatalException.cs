...
namespace PatioFIX.Common.FixSupport
{
    ...
    /// </summary>
    [Serializable]
    public class PtFixFatalException : PtFixException
    {
        /// <summary>
        ...
        public PtFixFatalException(string message)
            : base(message)
        {
        }
        ...
        protected PtFixFatalException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public PtFixFatalException(string message, Exception innerException)
