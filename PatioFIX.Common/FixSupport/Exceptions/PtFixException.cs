...
{
    [Serializable]
    public class PtFixException : PtException
    {
        ...
        public PtFixException(string message)
            : base(message)
        {
        }
        ...
        protected PtFixException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public PtFixException(string message, Exception innerException)
