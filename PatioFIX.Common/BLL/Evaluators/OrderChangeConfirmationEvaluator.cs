...
namespace PatioFIX.Common.BLL.Evaluators
{
    ...
    /// 
    /// </summary>
    class OrderChangeConfirmationEvaluator : BaseEvaluator
    {
        ...
        public OrderChangeConfirmationEvaluator(IOdlDataLayer datalayer) : base(datalayer)
        {
            theLogger = new Logger("OrderChangeConfirmationEvaluator");
        }
        ...
        public override EvaluationResult Evaluate(FIXInMessage fixInMessage, IODLMessage odlMessage)
        {
            ...
            if (fixInMessage.ODLMessageType != ODLMessageTypeEnum.Order_Change_Confirmation) throw new PtBusinessException($"InvalidMessageType. Need Order_Change_Confirmation but received {fixInMessage.ODLMessageType}");
            #endregion
