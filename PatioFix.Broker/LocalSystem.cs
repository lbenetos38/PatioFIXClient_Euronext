...
namespace PatioFix.Broker
{
    internal static class LocalSystem
    {
        ...
        public static string SendMessagesGuardRootPath
        {
            get
            {
                return Path.Combine(CommonPath, "SendMessagesGuard");
            }
        }
        ...
        static void EnsureLocalDirectories()
        {
            ...
            if (!Directory.Exists(SendMessagesGuardRootPath))
            {
                Directory.CreateDirectory(SendMessagesGuardRootPath);
            }
        }
        /// <summary>
        /// 
        ...
        public static void PeriodicTasks(Logger theLogger)
        {
            ...
            if (prvDayOfYear != Globals.DayOfYear)
            {
                ...
                /*
				 * κανω reset το SendMessagesGuard:
				 */
                SendMessagesGuard.Instance.Reset();

                /*
                 */
                UnConfirmedPool.Instance.Reset();
            }
        }
    }
}
