...
namespace PatioFIX.WatchDog.Actors
{
    ...
    /// </summary>
    internal class BrokerMonitoringServer : MonitoringServer
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public BrokerMonitoringServer(ManualResetEvent forceCancelEvent, string uri, bool logRequests = false) : base("BrokerWebServer", forceCancelEvent, uri, logRequests)
        {
        ...
        void Prometheus(HttpListenerContext context)
        {
            ...
            var metrics = BrokerMetrics.Instance.ReadAccumulator();
            ...
            sb.AppendFormat("odl_errors{{source=\"OrdersDispatcher\"}} {0}\n", metrics.Errors_OrdersDispatcher);
            ...
            sb.AppendFormat("odl_warnings{{source=\"Controller\"}} {0}\n", metrics.Warnings_TheController);
            sb.AppendFormat("odl_warnings{{source=\"EventsListener\"}} {0}\n", metrics.Warnings_EventsListener);
            sb.AppendFormat("odl_warnings{{source=\"OrdersDispatcher\"}} {0}\n", metrics.Warnings_OrdersDispatcher);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"SendMessage_GUARD\"}} {0}\n", metrics.Warnings_SendMessage_Guard);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"SendMessage_FAILLED\"}} {0}\n", metrics.Warnings_SendMessage_Failled);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"SendMessage_RETRY\"}} {0}\n", metrics.Warnings_SendMessage_Retries);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"SendMessage_EXPIRED\"}} {0}\n", metrics.Warnings_SendMessage_Expired);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"SetOutBoundMsg_Timeout\"}} {0}\n", metrics.Warnings_SetOutBound_Timeout);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"SetOutBoundMsg_Deadlock\"}} {0}\n", metrics.Warnings_SetOutBound_Deadlock);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"Restore_failed\"}} {0}\n", metrics.Warnings_Restore_failed);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"UnSetOutBoundMsg_Timeout\"}} {0}\n", metrics.Warnings_UnSetOutBound_Timeout);
            sb.AppendFormat("odl_warnings{{source=\"Dispatcher\", type=\"UnSetOutBoundMsg_Deadlock\"}} {0}\n", metrics.Warnings_UnSetOutBound_Deadlock);
            sb.Append("\n");
            ...
            sb.Append("# TYPE UnConfirmedPool_NumOfMessages gauge\n");
            sb.AppendFormat(CultureInfo.InvariantCulture, "UnConfirmedPool_NumOfMessages {0}\n", metrics.UnConfirmedPool_NumOfMessages);
            sb.Append("\n");
