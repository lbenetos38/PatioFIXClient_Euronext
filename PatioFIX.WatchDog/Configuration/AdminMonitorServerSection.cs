...
namespace PatioFIX.WatchDog
{
    ...
    /// 
    /// </summary>
    internal class AdminMonitorServerSection
    {
        /// <summary>
        /// 
        /// </summary>
        public string SectionName { get; } = "AdminMonitorServer";
        ...
        internal AdminMonitorServerSection(IConfigurationSection root, bool required = false)
        {
        ...
        internal void DumpSettings(Logger theLogger)
        {
            if (this.Enable)
            {
                theLogger.Info("AdminMonitorServerSection::\tENABLED");
                theLogger.Info($"AdminMonitorServerSection::URI = {this.URI}");
            }
            else
            {
                theLogger.Info("AdminMonitorServerSection::\tDISABLED");
            }
        }
    }
}
